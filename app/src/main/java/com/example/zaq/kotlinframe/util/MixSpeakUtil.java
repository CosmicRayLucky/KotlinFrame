...
/**
 * Created by Zhang Aqi on 2019/5/14. 09:08
...
public class MixSpeakUtil implements SpeechSynthesizerListener {
    ...
    private String appId = Constants.BaiDuParams.BAIDU_APPID;//请更换为自己创建的应用
    private static final String appKey = Constants.BaiDuParams.BAIDU_API_KEY;//请更换为自己创建的应用
    private static final String secretKey = Constants.BaiDuParams.BAIDU_SECRET_KEY;
